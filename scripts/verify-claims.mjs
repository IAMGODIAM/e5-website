...
const FORBIDDEN_CLAIMS = [
  ...
  [/E5\s+Enclave(?:&rsquo;|'|’)?s?\s+NSF\s+SBIR/i, 'NSF SBIR applicant is AgriMesh Corporation, not E5 Enclave; align attribution (O10)'],
  [/E5(?:&rsquo;|'|’)?s\s+NSF\s+SBIR/i,              'NSF SBIR applicant is AgriMesh Corporation, not E5 Enclave; align attribution (O10)'],
  [/concepts\s+from\s+E5\s+Enclave/i,               'do not attribute AgriMesh NSF SBIR concepts to E5 Enclave; attribute to AgriMesh Corporation (O10)'],
