---
layout: dispatch
permalink: /record/parallel-negros/
slug: parallel-negros
order: 1
numeral: "I"
...
chapters:
  - { id: "introduction", numeral: "i", label: "Introduction" }
  - { id: "two-negros-parallel-semantic-outputs-of-", numeral: "ii", label: "Two *Negros* — Parallel Semantic Outputs of Latin Niger" }
  - { id: "the-ibn-ya-ya-cognomen-in-its-documentar", numeral: "iii", label: "The Ibn Yaḥya Cognomen *in its Documentary Reality*" }
  - { id: "after-1492-the-portuguese-nation-on-the-", numeral: "iv", label: "After *1492* — The Portuguese Nation on the Atlantic" }
  - { id: "creolization-at-the-rivers-of-guinea-lan", numeral: "v", label: "Creolization at the *Rivers of Guinea* — Lançados, Tangomãos, Nharas, Kassanké" }
  - { id: "the-petite-c-te-peregrino-mesquita-vaz-d", numeral: "vi", label: "The Petite Côte — Peregrino, Mesquita, Vaz de Sousa *under Wolof Protection*" }
  - { id: "structural-overlap-without-demographic-c", numeral: "vii", label: "Structural Overlap *without Demographic Coincidence*" }
  - { id: "the-1685-code-noir-in-its-documentary-re", numeral: "viii", label: "The *1685 Code Noir* in Its Documentary Reality" }
  - { id: "conclusion", numeral: "ix", label: "Conclusion" }
citations:
  apa: "Lee, I. (2026). Parallel Negros. E5 Enclave."
  chicago: "Lee, Israel. \"Parallel Negros.\" E5 Enclave, 2026."
  bibtex: |
...
methodologyNote: "A synthesis of Iberian chancery archive, ethnonymic etymology, and post-1492 Atlantic creolization, organized to surface the parallel architectures of citizenship, capital, and coercion that have shaped the lineage's path through American history."
---
Abstract
...
{% marginalia "Keywords" %}
<div class="item">Upper Guinea</div>
      <div class="item">Sephardic diaspora</div>
      <div class="item">Creolization</div>
      <div class="item">Petite Côte</div>
      <div class="item">Atlantic slave trade</div>
      <div class="item">Polysemy</div>
      <div class="item">Code Noir</div>
      <div class="item">Lançados</div>
      
      <div class="item" style="font-style:normal;font-family:Inter,sans-serif;font-size:11px;letter-spacing:0.16em;text-transform:uppercase;">E5 Enclave Inc.
EIN 99-3822441
Liberty City, Miami</div>
{% endmarginalia %}
...
{% pullQuote "❧" %}
The claim made here is a synthesis, not a discovery.
{% endpullQuote %}
...
<h2 id="two-negros-parallel-semantic-outputs-of-">Two *Negros* — Parallel Semantic Outputs of Latin Niger</h2>
...
{% marginalia "Etymological apparatus" %}
<div class="ruled-margin" style="margin-bottom:14px;">
        
        Lat. niger, -gra, -grum — "black, dark; ill-omened." De Vaan, EDL.
      </div>
      <div class="ruled-margin" style="margin-bottom:14px;">
        
        REW §5917; OPort. *negro* < Lat. nigrum attested c. 12c.
      </div>
      <div class="ruled-margin" style="margin-bottom:14px;">
        
        12c. — el Negro / o Negro fixed as cognomen in Ibn Yaḥya line, post-1147 Santarém.
      </div>
      <div class="ruled-margin">
        
        1332 — ANTT Almoster, "moro negro de color." Earliest documented Iberian sale-deed usage.
      </div>
{% endmarginalia %}

iii.

<h2 id="the-ibn-ya-ya-cognomen-in-its-documentar">The Ibn Yaḥya Cognomen *in its Documentary Reality*</h2>
...
<h2 id="after-1492-the-portuguese-nation-on-the-">After *1492* — The Portuguese Nation on the Atlantic</h2>
...
<h2 id="creolization-at-the-rivers-of-guinea-lan">Creolization at the *Rivers of Guinea* — Lançados, Tangomãos, Nharas, Kassanké</h2>
...
{% pullQuote "❧" %}
The merchants of the Petite Côte participated marginally in the slave trade, and fully in the blade-weapons trade.
{% endpullQuote %}
...
{% marginalia "Geography" %}
<div class="ruled-margin" style="margin-bottom:14px;">
        
        Cabo Verde · Cacheu · Bugendo · Casamance · Gambia · Sierra Leone · Petite Côte (Joal, Porto d'Ale).
      </div>
      
      <div class="ruled-margin" style="margin-bottom:14px;">
        
        Portuguese / Cabo Verdean settlers — many New Christian.
      </div>
      <div class="ruled-margin" style="margin-bottom:14px;">
        
        Luso-African women traders, precursors of the *signares*.
      </div>
      <div class="ruled-margin">
        
        Sovereign African polities granting protection.
      </div>
{% endmarginalia %}

vi.

<h2 id="the-petite-c-te-peregrino-mesquita-vaz-d">The Petite Côte — Peregrino, Mesquita, Vaz de Sousa *under Wolof Protection*</h2>
...
<h2 id="structural-overlap-without-demographic-c">Structural Overlap *without Demographic Coincidence*</h2>
...
<h2 id="the-1685-code-noir-in-its-documentary-re">The *1685 Code Noir* in Its Documentary Reality</h2>
