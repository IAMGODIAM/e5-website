...
eyebrow: "Flagship under Environmental — E5 Enclave Incorporated"
deck: "<em>cooperative urban agriculture, on-chain.</em>"
description: "Lineage Farms · FarmBlock is E5 Enclave Incorporated's cooperative urban agriculture program — community-owned farms, blockchain-anchored governance, and food sovereignty infrastructure in Liberty City, Miami. Built on three years of sovereign food technology research, anchored by NSF SBIR Phase I submission AgriMesh (Tracking #2451499)."
breadcrumbs:
  - { label: "Programs", url: "/" }
...
schema:
  ...
  description: Lineage Farms is E5 Enclave Incorporated's cooperative urban agriculture program — community-owned farms, blockchain-anchored governance, and food sovereignty infrastructure in Liberty City, Miami.
...
[Download the FDI Dataset →](/record/measure-the-wound/)
...
**Cooperative member-share** — Liberty City residents: [Coalition application →](/coalition/apply/)

**Partner organization** — peer cooperatives, food-system allies, ag-tech companies, USDA extension programs: [Contact us →](/contact/)

**Donate** to the founding fund and site development: [/donate/](/donate/)
